...
\subtitle{From Theoretical Paradox to Hardware Security}
...
\begin{frame}{Engineering Entanglement: The BBM92 Setup}
    \begin{figure}
        ...
        \caption{BBM92 Architecture: An untrusted central source (Charlie) distributes photons to Alice and Bob.}
    \end{figure}
\end{frame}
